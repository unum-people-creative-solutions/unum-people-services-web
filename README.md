...
- **Conformidade LGPD:** o checkbox de aceite de Termos de Uso/Privacidade que existia na tela de primeiro acesso (`NEW_PASSWORD_REQUIRED`) foi removido — esse fluxo agora é tratado nativamente pelo Hosted UI; o vínculo de aceite por usuário passa a ser gerenciado pelo Portal do Cliente (`TermAcceptance`, em implementação — ver `unum-people-services-api`).
